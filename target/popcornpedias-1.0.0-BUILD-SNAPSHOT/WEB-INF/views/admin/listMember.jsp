            ...
            <tr align="center">
                ...
                <td class="border">
                    <c:if test="${not empty member.memberImgName }"><img
                            src="/popcornpedia/resources/images/member/${member.memberImgName}"></c:if>
                    <c:if test="${empty member.memberImgName }"><img
                            src="/popcornpedia/resources/images/common/default-profile.png" width="30px"></c:if>
                </td>
                <td class="border">${member.joinDate}</td>
                <td class="border">
                    <a href="${contextPath}/admin/updateMemberForm.do?member_id=${member.member_id }"
                       class="btn btn-secondary"
                       style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .85rem;">수정</a>
                    <a href="${contextPath}/admin/deleteMember.do?member_id=${member.member_id }" class="btn btn-danger"
                       style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .85rem;"
