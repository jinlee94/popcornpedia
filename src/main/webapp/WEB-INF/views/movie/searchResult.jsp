...
<script type="text/javascript">
	...
	function onButtonClicked(keyword) {
			...
			var newUrl = "http://localhost:8080/popcornpedias/movie/movieSearch?keyword=" + encodeURIComponent(keyword) + "&page=1"; // 페이지 초기값 설정
	...
	function onPageNumberClick(page) {
		...
		var newUrl = "http://localhost:8080/popcornpedias/movie/movieSearch?keyword=" + encodeURIComponent(keyword) + "&page=" + page;
		window.location.href = newUrl;
    ...
    function onYearSelected() {
		...
		var newUrl = "http://localhost:8080/popcornpedias/movie/movieSearch?keyword=" + encodeURIComponent(selectedYear) + "&page=1";
		window.location.href = newUrl;
...
<div class="container mt-5 mb-3 px-4">
	...
	<form method="get" action="/popcornpedias/movie/movieSearch" class="row gx-2 justify-content-center">
		<div class="col-6">
